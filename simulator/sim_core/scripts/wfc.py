"""
Sourced from: https://medium.com/swlh/wave-function-collapse-tutorial-with-a-basic-exmaple-implementation-in-python-152d83d5cdb1
"""
...
def wfc(pixels, input_size, output_size):
...
if __name__=='__main__':
    ...
    pix = wfc(pixels, input_size=(4,4), output_size=(50,50))
    print(pix)
